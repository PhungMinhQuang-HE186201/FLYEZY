        ...
        <div id="main-content">
            ...
            <table class="entity">
                ...
                <tbody>
                    ...
                    SimpleDateFormat stf = new java.text.SimpleDateFormat("HH:mm");
                    ...
                    <tr>
                        <td><%= fd.getId()%></td>
                        <td><%= sdf.format(fd.getDate()) %></td>
                        <td><%= stf.format(fd.getTime()) %></td>
                        <td><%= NumberFormat.getInstance().format(fd.getPrice()) %>đ</td>
                        <td>
                            <%= planeCategoryName %>
                        </td>
                        <td>
                        ...
                        <td style="display: flex; justify-content: space-around">
                            <button style="margin-right: 5px" type="button" class="btn btn-info" data-toggle="modal" data-target="#update-<%=fd.getId()%>">
                                Update
                            </button>
