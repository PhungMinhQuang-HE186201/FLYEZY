            ...
            <div class="col-md-8">
                ...
                <div class="flight-detail" style="display: block">
                    <div class="flight-info" style="display: flex">
                        ...
                        <div style="width: 88%; display: flex; justify-content: space-between;align-items: center; padding: 30px 15px">
                            <div>
                            ...
                            <line x1="0" y1="15" x2="85" y2="15" stroke="#B1B9CB" stroke-width="2" stroke-dasharray="5,5" />
